...
export default function PapersPage() {
  ...
  const searchExternal = useCallback(async () => {
    ...
    try {
      ...
      setExtResults(data || [])
    } catch { pushToast({ message: 'External search failed', type: 'error' }) }
    setSearching(false)
  }, [query])
          ...
          <div className="flex gap-2">
            <div className="flex-1 relative">
              ...
              <input value={query} onChange={e=>setQuery(e.target.value)}
                ...
                className="w-full pl-9 pr-3 py-2 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-400"/>
            </div>
