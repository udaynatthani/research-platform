...
export default function Drawer({ isOpen, onClose, title, children, width='w-96' }) {
  ...
  return (
    <>
      ...
      <div className={`fixed right-0 top-0 h-full ${width} bg-white shadow-2xl z-40 flex flex-col transition-transform duration-300 ${isOpen?'translate-x-0':'translate-x-full'}`}>
